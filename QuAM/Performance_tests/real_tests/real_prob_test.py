            ...
            for dist_ind in range(len(distances)):
                ...
                for mark_ratio_ind in range(len(mark_ratios)):
                    ...
                    for i3 in range(len(ratio_range)): # iterate ratios
                        ...
                        print(n, format(ratio, "0.3f"), format(mark_ratio, "0.3f"), target_dist, format(success_prob, "0.4f"), format(good_failure_prob, "0.4f"), format(bad_failure_prob, "0.4f"), max_prob_ind)
                        # if max_prob < 0.9:
...
name = "real_vicinity_test_improved"

# vicinity_ideal_test(name, method="ezhov", approx_scheme="exact")
